         ...
         <div class="col-md-14">
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <th>city</th>
                <th>Address</th>
	<th><a href="addcustomer.php" class="btn btn-success">Add New</a></th>
                    </tr></thead>
                    <tbody>
                      <?php
                        ...
                        <a class='btn btn-danger' href='customers.php?user_id=$user_id&action=delete'>Delete<div class='ripple-container'></div></a>
                        </td></tr>";
                        }
                        mysqli_close($con);
                        ?>
